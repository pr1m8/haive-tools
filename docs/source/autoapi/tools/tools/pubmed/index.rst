...
:py:mod:`tools.tools.pubmed`
============================

.. py:module:: tools.tools.pubmed
...
.. autolink-examples:: tools.tools.pubmed
   :collapse:
...
.. autoapisummary::
   ...
   tools.tools.pubmed.get_pubmed_tools

.. py:function:: get_pubmed_tools()

   Get PubMed tools with proper error handling for missing credentials.

   :returns:

             List containing PubMed tools if available,
                   empty list otherwise.
   :rtype: list


   .. autolink-examples:: get_pubmed_tools
      :collapse:

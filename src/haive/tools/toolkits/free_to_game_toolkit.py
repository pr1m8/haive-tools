...
class GetAllGamesInput(BaseModel):
    ...
    platform: str | None = Field(None, description="Platform name, e.g. 'pc', 'browser'")
    category: str | None = Field(None, description="Category/tag, e.g. 'shooter', 'mmorpg'")
    sort_by: str | None = Field(None, description="Sort by one of: 'release-date', 'popularity', 'alphabetical', 'relevance'")
